...
#
# Generated by Vivado on Wed Apr 04 08:35:43 +0200 2018
...
xv_path="Z:/Vivado_2017_2/Vivado/2017.2"
...
# Script info
echo -e "clock.sh - Script generated by export_simulation (Vivado v2017.2 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clock xil_defaultlib.clock xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim clock -key {Behavioral:sim_1:Functional:clock} -tclbatch cmd.tcl -log simulate.log
}
...
{
  file="xsim.ini"
  lib_map_path="Z:/Vivado_2017_2/Vivado/2017.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
